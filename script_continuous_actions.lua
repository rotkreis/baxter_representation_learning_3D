...
USE_CONTINUOUS = true  --TODO: remove from here when stable enough
print(" USE_CONTINUOUS ACTIONS: ",USE_CONTINUOUS)
...
if USE_CUDA and not USE_SECOND_GPU then
   cutorch.setDevice(1)
end
