...
function train_Epoch(Models,Prior_Used,Log_Folder,LR)
	...
	print('Which priors are being applied?:')
	print(Prop)
	print(Temp)
	print(Rep)
	print(Caus)
	...
	for epoch=1, nbEpoch do
		...
		for numBatch=1, NbBatch do
			-- Each prior is applied sequentially after one another, and its corresponding
			-- criterion is optimized also sequentially
			if Temp then
...
for nb_test=1, #Tests_Todo do
	...
	print("Running test: "..nb_test,'. Saving in Log_Folder: '..Log_Folder.."...")
